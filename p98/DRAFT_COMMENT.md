...
Before posting, note forum Rules 1 and 2: audit98.py re-derives every claim below from
scratch in exact arithmetic, sharing no code with the searches that produced them.
