...
| p98 | #98 distinct distances in general position | exact values D_gen(3..7) = 1, 2, 3, 4, 5, the best known lower bound for 5 <= n <= 10 (tied at 4 and 11 to 13 with a later forum bound); D_gen(8) in [5,7] |
